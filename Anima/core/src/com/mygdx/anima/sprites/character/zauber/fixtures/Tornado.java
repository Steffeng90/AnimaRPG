...
public class Tornado extends ZauberFixture {
    int reichweite;

    public Tornado(HumanoideSprites.Richtung richtung, float zauberFixture) {
        ...
        stateTimer = 0;
        rueckstoss = 1;
        zauberQuelle = screen.getGame().getAssetManager().get("objekte/casts/tornado.png", Texture.class);
