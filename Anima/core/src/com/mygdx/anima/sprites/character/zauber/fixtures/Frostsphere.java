...
public class Frostsphere extends ZauberFixture {
    int reichweite;

    public Frostsphere(HumanoideSprites.Richtung richtung, float zauberFixture) {

        super(zauberFixture);
        System.out.println("Frostsphäre wird gezaubert");
        ...
        stateTimer = 0;
        rueckstoss = 1;
        zauberQuelle = screen.getGame().getAssetManager().get("objekte/casts/icetacle.png", Texture.class);
        ...
        zauber = new Animation(.15f, frames);
        frames.clear();
    ...
    public void richtungBestimmen(Held held) {
        ...
        //b2body.getPosition().set(zauberStartVector);
    }
}