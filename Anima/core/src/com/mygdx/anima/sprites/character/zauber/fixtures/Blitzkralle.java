...
public class Blitzkralle extends ZauberFixture {
    int reichweite;

    public Blitzkralle(HumanoideSprites.Richtung richtung, float zauberFixture) {
        ...
        stateTimer = 0;
        rueckstoss = 1;
        zauberQuelle = screen.getGame().getAssetManager().get("objekte/casts/lightningclaw.png", Texture.class);
