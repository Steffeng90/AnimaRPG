...
public class Gravitation extends ZauberFixture {
    int reichweite;

    public Gravitation(HumanoideSprites.Richtung richtung, float zauberFixture) {
        ...
        stateTimer = 0;
        rueckstoss = 1;
        zauberQuelle = screen.getGame().getAssetManager().get("objekte/casts/torrentacle.png", Texture.class);
