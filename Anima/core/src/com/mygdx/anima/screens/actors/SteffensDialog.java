...
/**
 * Created by Steffen on 21.12.2016.
 */
 ...
 * @author Nathan Sweet */
public class SteffensDialog extends Window {
    ...
    public SteffensDialog (String title, Skin skin) {
    ...
    public SteffensDialog (String title, Skin skin, String windowStyleName) {
    ...
    public SteffensDialog (String title, WindowStyle windowStyle) {
        ...
        focusListener = new FocusListener() {
            ...
            private void focusChanged (FocusEvent event) {
                ...
                if (     stage != null && stage.getRoot().getChildren().size > 0
                        && stage.getRoot().getChildren().peek() == SteffensDialog.this) { // Dialog is top most actor.
                    Actor newFocusedActor = event.getRelatedActor();
                    if (newFocusedActor != null && !newFocusedActor.isDescendantOf(SteffensDialog.this) &&
    ...
    public SteffensDialog text (String text) {
        if (skin == null)
    ...
    public SteffensDialog text (String text, LabelStyle labelStyle) {
        return text(new Label(text, labelStyle));
    }

    /** Adds the given Label to the content table */
    public SteffensDialog text (Label label) {
    ...
    public SteffensDialog button (String text) {
    ...
    public SteffensDialog button (String text, Object object) {
        if (skin == null)
            throw new IllegalStateException("This method may only be used if the dialog was constructed with a Skin.");
     ...
     * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
    public SteffensDialog button (String text, Object object, TextButtonStyle buttonStyle) {
        return button(new TextButton(text, buttonStyle), object);
    }

    /** Adds the given button to the button table. */
    public SteffensDialog button (Button button) {
        return button(button, null);
    }

    /** Adds the given button to the button table.
     * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
    public SteffensDialog button (Button button, Object object) {
    ...
    public SteffensDialog show (Stage stage, Action action) {
        clearActions();
    ...
    public SteffensDialog show (Stage stage) {
     ...
     * @see Keys */
    public SteffensDialog key (final int keycode, final Object object) {
